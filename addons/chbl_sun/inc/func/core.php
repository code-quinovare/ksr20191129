...
class Core extends WeModuleSite
{
    ...
    public function getMainMenu()
    {
        ...
        $cur_color = ' style="color:#d9534f;" ';
          ...
          $navemenu[9] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=ygquan&m=chbl_sun" class="panel-title wytitle" id="yframe-9"><icon style="color:#8d8d8d;" class="fa fa-gift"></icon>  营销管理</a>',
                'items' => array(
              ...
              $navemenu[123] = array(
                  ...
                  'items' => array(
                      ...
                      2 => $this->createMainMenu('集卡 ', $do, 'jkopen', ''),
                      3 => $this->createMainMenu('砍价 ', $do, 'kanjiaopen', ''),
                      4 => $this->createMainMenu('拼团 ', $do, 'pintuanopen', ''),
                  )
              );
