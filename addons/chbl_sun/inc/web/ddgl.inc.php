...
$total=pdo_fetchcolumn("SELECT count(*) FROM ".tablename('chbl_sun_order') .  " a"  . " left join " . tablename("chbl_sun_store") . " b on a.store_id=b.id".$where." ORDER BY a.time DESC",$data);
