...
function(core, tpl) {
    ...
    modal.init = function(params) {
        ...
        $("#openActionSheet").off("click").on("click",
        function() {
            if (goods.type == 0) {
                    ...
                    setTimeout(function() {
                        FoxUI.message.show({
                            ...
                            buttons: [{
                                ...
                                extraClass: 'btn-danger',
                                onclick: function() {
                                    //location.href = core.getUrl('commission/qrcode')
                                    location.href = 'http://shop.quinnovare.cn/app/index.php?i=8&c=entry&m=ewei_shopv2&do=mobile&r=creditshop'
                                }
                            }]
                        })
                    },
