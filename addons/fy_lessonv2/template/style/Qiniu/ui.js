...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="../addons/fy_teacher/template/mobile/images/loading.gif"/>');

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', '../addons/fy_teacher/template/mobile/images/media.jpg');
        ...
        $(img).on('load', function() {
            ...
            showImg.attr('src', '../addons/fy_teacher/template/mobile/images/pictrue.jpg');
            Wrapper.addClass('default');
        });
    }
};
