...
Page({
    ...
    ljqg: function() {
        var o = this, e = this.data.userinfo, n = this.data.QgGoodInfo.store_id, i = this.data.QgGoodInfo.id;
    ...
    location: function() {
        var t = this.data.StoreInfo.store.coordinates.split(","), a = this.data.StoreInfo.store;
        ...
        app.getUserInfo(function(t) {
            ...
            success: function(t) {
                ...
                !function t(a) {
                    ...
                    i.setData({
                        clock: function(t) {
                            var a = Math.floor(t), o = Math.floor(a / 3600 / 24), e = Math.floor(a / 3600 % 24), n = Math.floor(a / 60 % 60), i = Math.floor(a % 60);
                            o < 10 && (o = "0" + o);
                            e < 10 && (e = "0" + e);
                            i < 10 && (i = "0" + i);
                            n < 10 && (n = "0" + n);
    ...
    onShareAppMessage: function() {
        var t = this.data.userinfo, a = this.data.QgGoodInfo, o = t.name + "邀请你" + a.money + "元抢购" + a.name;
