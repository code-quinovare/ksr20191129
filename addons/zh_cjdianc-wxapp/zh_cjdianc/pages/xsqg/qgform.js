...
Page({
    ...
    formSubmit: function(a) {
        var o = this, t = this.data.userInfo.id, s = this.data.userInfo.openid, e = this.data.name, i = this.data.mobile, n = this.data.store.id, r = this.data.QgGoodInfo.money, d = this.data.QgGoodInfo.id, l = this.data.QgGoodInfo.logo, u = this.data.QgGoodInfo.name, c = this.data.note;
        if (console.log(t, s, e, i, n, r, d, l, u, c), app.util.request({
            ...
            var g = Number(this.data.userInfo.wallet), f = Number(r);
