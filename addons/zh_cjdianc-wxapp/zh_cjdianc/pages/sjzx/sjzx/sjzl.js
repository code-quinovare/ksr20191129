var imgArray, lbimgArray, app = getApp(), util = require("../../../utils/util.js"), siteinfo = require("../../../../siteinfo.js"), imgArray1 = [], lbimgArray1 = [], imglogo = "";
...
Page({
    ...
    bindTypeChange: function(e) {
        console.log("picker type 发生选择改变，携带值为", e.detail.value, this.data.hy[e.detail.value].id), 
        this.setData({
    ...
    chooseImage1: function() {
        var o = this, i = this.data.images1;
    ...
    lbchooseImage1: function() {
        var o = this, i = this.data.lbimages1;
    ...
    uploadimg1: function(e) {
        var a = this, t = e.i ? e.i : 0, o = e.success ? e.success : 0, i = e.fail ? e.fail : 0;
        wx.uploadFile({
            url: e.url,
            filePath: e.path[t],
            name: "upfile",
            ...
            complete: function() {
                console.log(t), ++t == e.path.length ? (a.setData({
                    images1: e.path
                }), wx.hideToast(), console.log("执行完毕"), console.log("成功：" + o + " 失败：" + i)) : (console.log(t), 
                e.i = t, e.success = o, e.fail = i, a.uploadimg1(e));
            }
        });
    },
    lbuploadimg1: function(e) {
        ...
        wx.uploadFile({
            ...
            complete: function() {
                ...
                e.i = t, e.success = o, e.fail = i, a.lbuploadimg1(e));
            }
        });
    },
    delete: function(e) {
        var a = e.currentTarget.dataset.index, t = this.data.images;
        t.splice(a, 1), imgArray.splice(a, 1), console.log("删除images里的图片后剩余的图片", t, imgArray), 
        this.setData({
            images: t
        });
    },
    delete1: function(e) {
        var a = e.currentTarget.dataset.index, t = this.data.images1;
        t.splice(a, 1), console.log("删除images1里的图片后剩余的图片", t), this.setData({
            images1: t
        });
    },
    lbdelete: function(e) {
        var a = e.currentTarget.dataset.index, t = this.data.lbimages;
        t.splice(a, 1), lbimgArray.splice(a, 1), console.log("删除lbimages里的图片后剩余的图片", lbimgArray), 
        this.setData({
            lbimages: t
        });
    },
    lbdelete1: function(e) {
        var a = e.currentTarget.dataset.index, t = this.data.lbimages1;
        t.splice(a, 1), lbimgArray1.splice(a, 1), console.log("删除lbimages1里的图片后剩余的图片", lbimgArray1), 
        this.setData({
            lbimages1: t
        });
    },
    formSubmit: function(e) {
        var a = this, t = a.data.images1;
        ...
        var l = e.detail.value.sjmc, s = e.detail.value.sjdh, n = e.detail.value.mdwz, c = this.data.jwd, r = e.detail.value.rjj, g = e.detail.value.qsj, u = e.detail.value.xyh, d = e.detail.value.xyhje, m = e.detail.value.mdgg;
        console.log(l, s, n, c, r, g, u, d, m);
        var h = "", f = !0;
        if ("" == imglogo) h = "请上传商家Logo！"; else if ("" == l) h = "请填写商家名称！"; else if ("" == s) h = "请填写商家手机号！"; else if (11 != s.length) h = "手机号错误！"; else if ("" == n) h = "请填写门店位置"; else if ("" == c) h = "请点击定位按钮进行定位"; else if ("" == r) h = "请填写人均价"; else if ("" == g) h = "请填写起送价"; else if ("" == d) h = "请填写新用户优惠金额"; else if ("" == m) h = "请填写门店公告"; else {
            var p = function() {
            ...
            f = !1, wx.showLoading({
                ...
                var t = a.i ? a.i : 0, o = a.success ? a.success : 0, i = a.fail ? a.fail : 0;
                wx.uploadFile({
                    url: a.url,
                    filePath: a.path[t],
                    name: "upfile",
                    ...
                    complete: function() {
                        console.log(t), ++t == a.path.length ? (wx.hideToast(), console.log("执行完毕"), p(), 
                        console.log("成功：" + o + " 失败：" + i)) : (console.log(t), a.i = t, a.success = o, 
                        a.fail = i, e(a));
                    }
                });
            }({
    ...
    onLoad: function(e) {
        ...
        var a = wx.getStorageSync("users").id, t = wx.getStorageSync("sjdsjid"), o = this;
