...
Page({
    ...
    formSubmit: function(t) {
        ...
        var a = wx.getStorageSync("sjdsjid"), o = Number(this.data.commission), i = Number(this.data.fxset.tx_zdmoney), s = t.detail.value.je, n = t.detail.value.name, l = t.detail.value.sjh, u = t.detail.value.yhkh, d = t.detail.value.khxx, c = t.detail.value.radiogroup;
    ...
    onLoad: function(t) {
        var e = this, a = wx.getStorageSync("sjdsjid"), o = wx.getStorageSync("users").id;
