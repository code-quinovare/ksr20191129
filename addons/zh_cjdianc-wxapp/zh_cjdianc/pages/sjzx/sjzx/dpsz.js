...
Page({
    ...
    formSubmit: function(t) {
        ...
        var e = this.data.szname, a = wx.getStorageSync("sjdsjid");
        if (console.log(e, a), 1 == e) {
            var i = t.detail.value.radiodyfs, o = t.detail.value.radiodysj;
        ...
        if (2 == e) {
            var s = t.detail.value.radiosfyy, n = t.detail.value.time, d = t.detail.value.time1, l = t.detail.value.time2, r = t.detail.value.time3;
