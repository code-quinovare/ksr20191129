...
Page({
    ...
    cartaddformSubmit: function(t) {
        ...
        var a = this, e = this.data.storeinfo.store.admin_id;
        app.util.request({
    ...
    jdswitchChange: function(a) {
        ...
        if (console.log(t), console.log("jdswitchChange 发生 change 事件，携带值为", a.detail.value), 
        a.detail.value) var o = 1; else o = 2;
    ...
    onLoad: function(t) {
        var a = this, e = wx.getStorageSync("sjdsjid"), o = wx.getStorageSync("users").id;
    ...
    reLoad: function() {
        var a = this, t = this.data.storeinfo.store.admin_id;
        app.util.request({
