var dsq, app = getApp(), siteinfo = require("../../../../siteinfo.js");
...
Page({
    ...
    psxq: function(t) {
        var e = this, a = t.currentTarget.dataset.id, o = t.currentTarget.dataset.sjid, n = t.currentTarget.dataset.psmode;
    ...
    reLoad: function() {
        var t, a = this, e = this.data.status || 1, o = wx.getStorageSync("sjdsjid"), n = this.data.pagenum, s = "";
        1 == e && (t = "2"), 2 == e && (t = "3", s = "2"), 3 == e && (t = "3", s = "1"), 
        4 == e && (t = "4,5"), 5 == e && (t = "6,7,8,9,10"), console.log(e, t, s, o, n), 
        app.util.request({
    ...
    onLoad: function(t) {
        var e = this, a = wx.getStorageSync("sjdsjid"), o = siteinfo.siteroot.replace("app/index.php", "");
        console.log(a, o), this.reLoad(), app.setNavigationBarColor(this), app.sjdpageOnLoad(this), 
        app.util.request({
