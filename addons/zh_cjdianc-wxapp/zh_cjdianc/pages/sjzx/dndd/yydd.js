...
Page((_defineProperty(_Page = {
    ...
    xztype: function(t) {
        ...
        console.log(a), 0 == a && (e = ""), 1 == a && (e = "2"), 2 == a && (e = "3"), 3 == a && (e = "4"), 
        this.setData({
    ...
    reLoad: function() {
        var s = this, t = this.data.status || 1, e = this.data.state || "", a = this.data.searchinfo || "", i = wx.getStorageSync("sjdsjid"), n = this.data.pagenum, o = this.data.start_time, d = this.data.end_time;
    ...
    var e = this, a = t.currentTarget.dataset.id, s = t.currentTarget.dataset.type;
