...
Page({
    ...
    reLoad: function() {
        var t, e = this, a = this.data.status || 1, n = wx.getStorageSync("sjdsjid"), s = this.data.pagenum;
    ...
    onLoad: function(t) {
        var e = this, a = wx.getStorageSync("sjdsjid"), n = siteinfo.siteroot.replace("app/index.php", "");
