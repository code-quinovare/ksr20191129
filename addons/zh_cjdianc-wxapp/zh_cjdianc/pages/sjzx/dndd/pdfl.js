...
Page({
    ...
    formSubmit1: function(t) {
        ...
        var e = this;
        if (t.detail.value.sfxs) var a = 1; else a = 2;
        var i = wx.getStorageSync("sjdsjid"), o = t.detail.value.flmc, s = t.detail.value.pxxh;
        console.log("", i, o, s, a);
        var n = "", l = !0;
    ...
    formSubmit: function(t) {
        ...
        if (t.detail.value.sfxs) var i = 1; else i = 2;
        var o = wx.getStorageSync("sjdsjid"), s = t.detail.value.flmc, n = t.detail.value.pxxh;
