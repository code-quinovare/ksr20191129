...
Page({
    ...
    reLoad: function() {
        var t, a = this, e = this.data.table_id, s = this.data.status || 1, i = this.data.time || "", n = wx.getStorageSync("sjdsjid"), o = this.data.pagenum, d = this.data.start_time, c = this.data.end_time;
        1 == s && (t = "1,2,3"), 2 == s && (t = "1"), 3 == s && (t = "2"), 4 == s && (t = "3"), 
        console.log(s, t, i, d, c, n, o, e), app.util.request({
    ...
    qkt: function(t) {
        var e = this, a = this.data.table_id;
