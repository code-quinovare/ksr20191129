...
Page({
    ...
    onLoad: function(e) {
        app.setNavigationBarColor(this), console.log(e, this.data.cpid), null != e.cpid && (this.setData({
            ...
            success: function(t) {
                ...
                "1" == t.data.is_hot && (e[0].checked = !0), "1" == t.data.is_tj && (e[1].checked = !0), 
                "1" == t.data.is_new && (e[2].checked = !0), "1" == t.data.is_zp && (e[3].checked = !0);
    ...
    formSubmit: function(e) {
        ...
        var a = this, t = this.data.cpid, s = this.data.checkboxItems, o = s[0].checked ? 1 : 2, i = s[1].checked ? 1 : 2, n = s[2].checked ? 1 : 2, l = s[3].checked ? 1 : 2, d = wx.getStorageSync("sjdsjid"), c = e.detail.value.sppx, u = e.detail.value.spmc, p = e.detail.value.cpkc, h = e.detail.value.yxsl, x = e.detail.value.dnjg, r = e.detail.value.yj, g = e.detail.value.wmjg, m = e.detail.value.bzfy, f = e.detail.value.xgfs, v = e.detail.value.qsfs, w = e.detail.value.spjj, j = this.data.splogo, y = this.data.spfl[this.data.spflIndex].id, b = Number(this.data.spxxIndex) + 1, _ = Number(this.data.sjxjIndex) + 1;
