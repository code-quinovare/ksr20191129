...
Page({
    ...
    onLoad: function(a) {
        ...
        app.util.request({
            ...
            success: function(a) {
                console.log("MyJrRank", a.data), a.data.time3 = util.ormatDate(a.data.time3).substring(11), 
                t.setData({
                    MyRank: a.data
                });
            }
    ...
    rank: function() {
        var e = this, s = (wx.getStorageSync("users").id, e.data.rankpage), a = e.data.zrankpage, n = e.data.sranklist, t = e.data.szrank;
    ...
    zrank: function() {
        var t = this, a = (wx.getStorageSync("users").id, t.data.rankpage), e = t.data.zrankpage, s = t.data.sranklist, n = t.data.szrank;
