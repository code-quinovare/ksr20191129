...
Page({
    ...
    reLoad: function() {
        ...
        var c = this, t = wx.getStorageSync("users").id;
        app.util.request({
                ...
                app.util.request({
                    ...
                    success: function(t) {
                        ...
                        for (var e = t.data, a = 0; a < e.length; a++) {
                            ...
                            var s = new Date(e[a].day[0], e[a].day[1] - 1, e[a].day[2]), n = s.getFullYear(), o = s.getMonth() + 1, l = s.getDate();
                            e[a].day = n + "," + o + "," + l;
                        }
    ...
    qd: function() {
        ...
        if (console.log(t), "" != t.img && "" != t.name) {
            var a = wx.getStorageSync("users").id, s = this.data.wdqd;
    ...
    bq: function() {
        var e = this, t = this.data.userinfo;
        if (console.log(t), "" != t.img && "" != t.name) {
            var a = wx.getStorageSync("users").id, s = this.data.wdqd, n = Number(this.data.grjf);
            ...
            if (0 == s.length) var i = e.data.qdset[0].one; else i = 0;
    ...
    selectDate: function(t) {
        ...
        var l = new Date(s[0], s[1], s[2]), i = new Date(n[0], n[1], n[2]), r = l.getTime(), d = i.getTime();
