var dot_inter, app = getApp(), WxParse = require("../../../pages/wxParse/wxParse.js");
...
Page({
    ...
    onLoad: function(t) {
        ...
        var n = wx.getStorageSync("openid"), a = wx.getStorageSync("users"), i = a ? a.id : 0, r = t.d_user_id ? t.d_user_id : 0;
        console.log(r + "--" + i + "--" + o + "--" + n), n ? 0 != r && r != i ? app.util.request({
            ...
            success: function(t) {
                ...
                app.util.request({
                    ...
                    success: function(t) {
                        n = t.data.openid, console.log(n), 0 != r && r != i ? app.util.request({
                            url: "entry/wxapp/SaveEatShare",
                            data: {
                                gid: o,
                                share_uid: r,
    ...
    onReady: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                if (2 != t.data) {
                    var a = o.data.rouletteData, e = a.award;
                    ...
                    a.award = e, o.setData({
                        ...
                        title: t.data.gname
                    }), t.data.content && WxParse.wxParse("content", "html", t.data.content, o, 20), 
                    t.data.usenotice && WxParse.wxParse("usenotice", "html", t.data.usenotice, o, 20);
                } else o.setData({
                    goods: []
                });
            }
    ...
    onShow: function() {
        ...
        var a = wx.getStorageSync("openid"), e = wx.getStorageSync("users"), o = r.data.optionsdata.id;
        e || r.setData({
            is_modal_Hidden: !1
        }), app.util.request({
    ...
    drawCanvas: function() {
        var t = wx.createCanvasContext("roulette", this), a = this.data.rouletteData, e = 295;
        t.translate(147.5, 147.5), t.clearRect(-e, -295, e, 295);
        var o = 2 * Math.PI / 360 * 60, n = 2 * Math.PI / 360 * -90;
        Math.PI;
        t.rotate(-30 * Math.PI / 180), t.beginPath(), t.lineWidth = 20, t.strokeStyle = a.bgOut, 
        t.arc(0, 0, 130, 0, 2 * Math.PI), t.stroke();
        for (var i = a.dotColor, r = 0; r < 26; r++) {
            t.beginPath();
            var d = 131 * Math.cos(n), s = 131 * Math.sin(n);
            t.fillStyle = i[r % i.length], t.arc(d, s, 5, 0, 2 * Math.PI), t.fill(), n += 2 * Math.PI / 360 * (360 / 26);
        }
        t.draw();
    },
    beforegetLottery: function() {
        var a = this, e = a.data.goods, t = wx.getStorageSync("openid"), o = wx.getStorageSync("users");
        app.util.request({
    ...
    getLottery: function() {
        var e = this, t = e.data.rouletteData;
        if (!e.data.iscandraw) return wx.showToast({
            title: "数据加载中，请稍后...",
            icon: "none"
        }), !1;
        var o = e.data.goods, a = [];
        a[0] = o.grandprobability / 100, a[1] = o.firstprobability / 100, a[2] = o.secondprobability / 100, 
        a[3] = o.thirdprobability / 100, a[4] = o.fourthprobability / 100, a[5] = o.notwonprobability / 100;
        var n = e.random(a);
        null == n && (n = 5), console.log(n);
        t.award;
        var i = wx.createAnimation({
            duration: 1
        });
        (this.animationInit = i).rotate(0).step(), this.setData({
            ...
            (e.animationRun = t).rotate(2880 - 60 * n).step(), e.setData({
                animationData: t.export()
            });
        }, 100), setTimeout(function() {
            var t = wx.getStorageSync("openid"), a = wx.getStorageSync("users");
            app.util.request({
