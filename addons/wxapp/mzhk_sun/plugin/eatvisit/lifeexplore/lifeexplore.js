...
Page({
    ...
    onReady: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                if (2 != t.data) {
                    var e = t.data, a = e.url + e.posterimg;
    ...
    drawImage: function(i) {
        var s = this, t = wx.getStorageSync("users");
        app.util.request({
            ...
            success: function(t) {
                var a = t.data.wxcode_pic, o = app.siteInfo.siteroot.split("/app/")[0] + "/attachment/", e = new Promise(function(e, t) {
                    wx.getImageInfo({
                        src: i,
                        success: function(t) {
                ...
                Promise.all([ e, n ]).then(function(t) {
                    var e = t[0], a = t[1], o = wx.createCanvasContext("image");
                    o.beginPath(), o.setStrokeStyle("#ff9e40"), o.rect(0, 0, 710, 1e3), o.setFillStyle("#ff9e40"), 
                    o.fill(), o.stroke(), o.drawImage(e, 20, 20, 670, 960), o.drawImage(a, 25, 725, 250, 250), 
                    o.draw(), new Promise(function(t, e) {
                        setTimeout(function() {
                            t("second ok");
                        }, 500);
                    }).then(function(t) {
