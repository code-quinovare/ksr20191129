...
Page({
    ...
    onLoad: function(t) {
        ...
        var r = t.tab, o = a.data.status[r], n = wx.getStorageSync("openid");
        app.util.request({
    ...
    bargainTap: function(t) {
        var a = this, e = parseInt(t.currentTarget.dataset.index), r = a.data.status[e], o = wx.getStorageSync("openid"), n = [ 1, 1, 1, 1 ];
        app.util.request({
            url: "entry/wxapp/getjkOrder",
            cachetime: "10",
            data: {
    ...
    onReachBottom: function() {
        var e = this, t = e.data.curIndex, a = (e.data.status[t], wx.getStorageSync("openid")), r = e.data.orderlist, o = e.data.page;
        app.util.request({
            url: "entry/wxapp/getjkOrder",
            cachetime: "10",
            data: {
