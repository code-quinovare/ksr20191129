...
Page({
    ...
    onLoad: function(s) {
        ...
        a ? n.setData({
            ...
            cachetime: "30",
            success: function(e) {
                wx.setStorageSync("url", e.data), a = e.data, n.setData({
                    url: a
                });
            }
        });
    ...
    formSubmit: function(e) {
        var a = !0, t = "", r = this, i = wx.getStorageSync("openid"), o = r.data.sincetype, s = r.data.deliveryfee, n = r.data.payType, d = r.data.time, c = r.data.uremark, p = r.data.shiptypetitle[o], l = (i = wx.getStorageSync("openid"), 
        ...
        if ("1" == o) if (f && "" != f) if ("" == n) t = "请选择支付方式"; else {
            a = !1;
            var _ = {
                price: l,
                id: u,
        ...
        x && 0 < D ? (console.log("正在执行继续支付"), 0 < l ? (k.orderarr = {
            ...
            form_id: S,
            typeid: 6
        }, app.func.orderarr(app, r, k)) : (k.SendMessagePay = {
            id: u,
            price: l,
            order_id: D,
            openid: i,
