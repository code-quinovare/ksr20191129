...
func.gotourl = function(e, a, s) {
    ...
    if (2 == n) i = "/mzhk_sun/pages/index/bargain/bargain"; else if (3 == n) i = "/mzhk_sun/pages/index/cards/cards"; else if (4 == n) i = "/mzhk_sun/pages/index/timebuy/timebuy"; else if (5 == n) i = "/mzhk_sun/pages/index/group/group"; else if (6 == n) i = "/mzhk_sun/pages/index/shop/shop?id=" + s; else if (7 == n) i = "/mzhk_sun/pages/index/bardet/bardet?id=" + s; else if (8 == n) i = "/mzhk_sun/pages/index/cardsdet/cardsdet?gid=" + s; else if (9 == n) i = "/mzhk_sun/pages/index/package/package?id=" + s; else if (10 == n) i = "/mzhk_sun/pages/index/groupdet/groupdet?id=" + s; else if (11 == n) i = "/mzhk_sun/pages/index/welfare/welfare?id=" + s; else if (13 == n) i = "/mzhk_sun/pages/index/freedet/freedet?id=" + s; else if (14 == n) i = "/mzhk_sun/pages/index/free/free"; else if (15 == n) i = "/mzhk_sun/pages/index/index", 
    r = !0; else if (16 == n) i = "/mzhk_sun/pages/active/active", r = !0; else if (17 == n) i = "/mzhk_sun/pages/goods/goods", 
    r = !0; else if (18 == n) i = "/mzhk_sun/pages/user/user", r = !0; else if (19 == n) i = "/mzhk_sun/pages/index/news/news"; else if (20 == n) i = "/mzhk_sun/pages/index/article/article?id=" + s; else if (21 == n) i = "/mzhk_sun/pages/dynamic/dynamic", 
    r = !0; else if (24 == n) i = "/mzhk_sun/pages/member/member"; else if (25 == n) i = "/mzhk_sun/pages/user/recharge/recharge"; else if (28 == n) i = "/mzhk_sun/plugin/eatvisit/life/life"; else {
        if (26 == n) {
            ...
            return e.util.request({
                ...
                success: function(e) {
                    if (e) {
                        var a = e.data;
                        9 != a ? (i = 1 == a.status ? "/mzhk_sun/plugin/distribution/fxCenter/fxCenter" : "/mzhk_sun/plugin/distribution/fxAddShare/fxAddShare", 
                        wx.navigateTo({
                            url: i
                        })) : wx.showModal({
                            title: "提示信息",
                            ...
                            showCancel: !1,
                            success: function(e) {
                                i = "/mzhk_sun/pages/user/user", wx.navigateTo({
                                    url: i
                                });
                            }
                        });
        ...
        if (22 == n) return wx.scanCode({
            success: function(e) {
                ...
                var a = "/mzhk_sun/pages/user/pay/pay?bid=" + JSON.parse(e.result).bid;
                wx.navigateTo({
                    url: a
                });
            }
    ...
    var e = wx.getStorageSync("have_wxauth"), t = wx.getStorageSync("openid"), n = wx.getStorageSync("users");
    e && t && n || wx.getSetting({
        success: function(e) {
