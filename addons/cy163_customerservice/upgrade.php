...
if(!pdo_fieldexists("messikefu_group", "isdel")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_group")." ADD   `isdel` tinyint(1) NOT NULL;");
}
...
if(!pdo_fieldexists("messikefu_xcx", "uniacid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `uniacid` int(11) DEFAULT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "name")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `name` varchar(30) DEFAULT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "gh_id")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `gh_id` varchar(30) DEFAULT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "appid")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `appid` varchar(30) DEFAULT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "secret")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `secret` varchar(50) DEFAULT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "token")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `token` varchar(50) DEFAULT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "aeskey")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `aeskey` varchar(50) DEFAULT NULL;");
}
if(!pdo_fieldexists("messikefu_xcx", "url")) {
 pdo_query("ALTER TABLE ".tablename("messikefu_xcx")." ADD   `url` varchar(200) DEFAULT NULL;");
}
