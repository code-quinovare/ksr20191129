...
class dayu_form_plugin_skinsModuleSite extends WeModuleSite
{
	...
	public function doWebSkins()
	{
		...
		if ($operation == 'display' && $_W['isfounder']) {
			...
			if (!empty($_GPC['export'])) {
				$arr2 = array(array("weui", "weui", "weui默认皮肤", "../addons/dayu_form_plugin_skins/template/images/weui.jpg", "9"), array("weui2", "weui2", "多选单选无弹出", "../addons/dayu_form_plugin_skins/template/images/weui2.jpg", "9"), array("weui3", "weui3", "顶部显示详细说明，支持富文本", "../addons/dayu_form_plugin_skins/template/images/weui3.jpg", "9"), array("weui4", "weui4", "大示例图", "../addons/dayu_form_plugin_skins/template/images/weui4.jpg", "9"), array("weui+mui", "weuiup", "MUI上传后压缩，不建议", "../addons/dayu_form_plugin_skins/template/images/weuiup.jpg", "8"), array("仿宝洁", "weui_pg", "仿宝洁皮肤", "../addons/dayu_form_plugin_skins/template/images/weui_pg.jpg", "8"), array("花花", "weui_huahua", "花花定制", "../addons/dayu_form_plugin_skins/template/images/weui_huahua.jpg", "8"), array("不见不散", "weui_ju", "不见不散定制", "../addons/dayu_form_plugin_skins/template/images/weui_ju.jpg", "8"), array("战刀", "weui_zhandao", "战刀定制", "../addons/dayu_form_plugin_skins/template/images/weui_zhandao.jpg", "8"));
				$data = array();
				for ($i = 0; $i < 9; $i++) {
	...
	public function doWebupfile()
	{
		...
		$destination_folder = "../addons/dayu_form/template/mobile/skins/";
