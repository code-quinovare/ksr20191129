...
if ($op == 'post') 
{
	...
	if ($_W['ispost']) 
	{
		...
		$insert = array('uniacid' => $_W['uniacid'], 'name' => $data['activity']['name'], 'type' => 'share', 'data' => base64_encode(json_encode($data)), 'condition' => floatval($data['activity']['condition']), 'starttime' => $startime, 'endtime' => $endtime, 'addtime' => TIMESTAMP);
		if (0 < $id) 
		{
