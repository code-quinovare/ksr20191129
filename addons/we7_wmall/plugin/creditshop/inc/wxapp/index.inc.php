...
if ($op == 'index') 
{
	$result = array('adv' => creditshop_adv_get(1), 'goods' => creditshop_goodsall_get(array('type' => 'goods', 'psize' => 4)), 'goods_credit2' => creditshop_goodsall_get(array('type' => 'credit2')), 'goods_redpacket' => creditshop_goodsall_get(array('type' => 'redpacket')), 'category' => creditshop_category_get(1), 'member' => $_W['member']);
