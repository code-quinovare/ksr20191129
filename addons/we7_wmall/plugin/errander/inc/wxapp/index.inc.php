...
if ($op == 'index') 
{
	$categorys = pdo_fetchall('select id, name, thumb from ' . tablename('tiny_wmall_errander_page') . ' where uniacid = :uniacid and agentid = :agentid', array(':uniacid' => $_W['uniacid'], ':agentid' => $_W['agentid']));
