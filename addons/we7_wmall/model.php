...
{
	$score = array('all' => intval($score), 'half' => is_float($score));
...
function Jpush_deliveryer_send($title, $alert, $extras = array(), $audience = '', $platform = 'all') 
{
	...
	load()->func('communication');
	$extra = array('Authorization' => 'Basic ' . base64_encode($config['push_key'] . ':' . $config['push_secret']));
