...
if ($ta == 'index') 
{
	if ($_W['ispost']) 
	{
		...
		$member = array('uniacid' => $_W['uniacid'], 'uid' => date('His') . random(3, true), 'mobile' => $mobile, 'mobile_audit' => 1, 'nickname' => '', 'salt' => random(6, true), 'token' => random(32), 'addtime' => TIMESTAMP, 'register_type' => 'mobile', 'is_sys' => 2);
