...
if ($ta == 'account') 
{
	...
	if ($_W['isajax']) 
	{
		...
		$data = array('uniacid' => $_W['uniacid'], 'mobile' => $mobile, 'title' => trim($_GPC['title']), 'openid' => $openid, 'nickname' => trim($_GPC['nickname']), 'avatar' => trim($_GPC['avatar']), 'salt' => random(6), 'addtime' => TIMESTAMP);
