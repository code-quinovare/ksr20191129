...
if ($op == 'detail') 
{
	...
	unset($order['agent_serve'], $order['plateform_serve'], $order['category']);
	$errander_type = errander_types();
	...
	$order['delivery_assign_time_cn'] = $order['delivery_instore_time_cn'] = $order['delivery_success_time_cn'] = array('day' => '未知', 'time' => '未知');
