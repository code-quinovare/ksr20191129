<?php
	...
	if (checksubmit()){
		...
		if($_GPC['type'] == '8'){
			$data = array(
			'uniacid' => $_W['uniacid'],
			'prizeodds' => $_GPC['yzprize_odds'],
			'prizesum' => $_GPC['yzprize_sum'],
			'type' => $_GPC['type'],
			'youzan_credit' => $_GPC['yz_credit'],
			'name' => $_GPC['yzcredit_name'],
			'pici' => $_GPC['pici'],
			'time' => time()
			);
		}
		if($_GPC['type'] == '9'){
			$data = array(
			'uniacid' => $_W['uniacid'],
			'prizeodds' => $_GPC['prize9_odds'],
			'prizesum' => $_GPC['prize9_sum'],
			'type' => $_GPC['type'],
			'name' => $_GPC['red9_name'],
			'credit' => $_GPC['red9_credit'],
			'min_money' => $_GPC['min9_money'],
			'max_money' => $_GPC['max9_money'],
			'pici' => $_GPC['pici'],
			'time' => time()
			);
		}
