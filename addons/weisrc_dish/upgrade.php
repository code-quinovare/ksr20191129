<?php
$sql="CREATE TABLE IF NOT EXISTS `ims_wechat_reply` (
...
";
pdo_run($sql);
if(!pdo_fieldexists('wechat_reply',  'id')) {
	pdo_query("ALTER TABLE ".tablename('wechat_reply')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('wechat_reply',  'title')) {
	pdo_query("ALTER TABLE ".tablename('wechat_reply')." ADD `title` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists('wechat_reply',  'url')) {
	pdo_query("ALTER TABLE ".tablename('wechat_reply')." ADD `url` varchar(500) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('wechat_reply',  'displayorder')) {
	pdo_query("ALTER TABLE ".tablename('wechat_reply')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists('wechat_reply',  'status')) {
	pdo_query("ALTER TABLE ".tablename('wechat_reply')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists('wechat_reply',  'dateline')) {
	pdo_query("ALTER TABLE ".tablename('wechat_reply')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists('weisrc_dish_account',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `from_user` varchar(100) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_account',  'status')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '状态';");
}
...
if(!pdo_fieldexists('weisrc_dish_ad',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `title` varchar(100) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_ad',  'url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `url` varchar(200) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_ad',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `thumb` varchar(500) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_blacklist',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_blacklist')." ADD `from_user` varchar(100) DEFAULT '' COMMENT '用户ID';");
}
...
if(!pdo_fieldexists('weisrc_dish_cart',  'optionid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_cart')." ADD `optionid` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_cart',  'optionname')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_cart')." ADD `optionname` varchar(200) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_commission',  'ordersn')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `ordersn` varchar(100) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_commission',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `from_user` varchar(100) DEFAULT '' COMMENT '购买者openid';");
}
...
if(!pdo_fieldexists('weisrc_dish_coupon',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `thumb` varchar(500) NOT NULL DEFAULT '' COMMENT '图片';");
}
...
if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_send')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_send` varchar(100) DEFAULT '' COMMENT '商户发送邮件邮箱';");
}
...
if(!pdo_fieldexists('weisrc_dish_email_setting',  'email')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email` varchar(100) DEFAULT '' COMMENT '商户接收邮件邮箱';");
}
if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_business_tpl')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_business_tpl` varchar(200) DEFAULT '' COMMENT '商户接收内容模板';");
}
...
if(!pdo_fieldexists('weisrc_dish_fans',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `from_user` varchar(50) DEFAULT '' COMMENT '用户ID';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'nickname')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `nickname` varchar(50) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'headimgurl')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `headimgurl` varchar(500) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'username')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `username` varchar(50) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'mobile')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `mobile` varchar(50) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'address')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `address` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'sex')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `sex` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '性别';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'country')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `country` varchar(50) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'province')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `province` varchar(50) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_fans',  'city')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `city` varchar(50) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_fans',  'paytime')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `paytime` int(10) DEFAULT '0' COMMENT '上次交易时间';");
}
...
if(!pdo_fieldexists('weisrc_dish_fans',  'scene_str')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `scene_str` varchar(500) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_feedback',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `from_user` varchar(100) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_feedback',  'content')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `content` varchar(500) DEFAULT '' COMMENT '回复内容';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'weid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号id';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'pcate')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `pcate` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分类';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `title` varchar(100) NOT NULL DEFAULT '' COMMENT '名称';");
}
if(!pdo_fieldexists('weisrc_dish_goods',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `thumb` varchar(500) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_goods',  'unitname')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `unitname` varchar(5) NOT NULL DEFAULT '份' COMMENT '单位';");
}
if(!pdo_fieldexists('weisrc_dish_goods',  'description')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `description` varchar(1000) NOT NULL DEFAULT '' COMMENT '描述';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'taste')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `taste` varchar(1000) NOT NULL DEFAULT '' COMMENT '口味';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'marketprice')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `marketprice` varchar(10) NOT NULL DEFAULT '' COMMENT '现价';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'productprice')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `productprice` varchar(10) NOT NULL DEFAULT '' COMMENT '原价';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'counts')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `counts` int(10) NOT NULL DEFAULT '-1' COMMENT '今日库存';");
}
if(!pdo_fieldexists('weisrc_dish_goods',  'today_counts')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `today_counts` int(10) NOT NULL DEFAULT '0' COMMENT '今日销售量';");
}
if(!pdo_fieldexists('weisrc_dish_goods',  'lasttime')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `lasttime` int(10) NOT NULL DEFAULT '0' COMMENT '更新时间';");
}
if(!pdo_fieldexists('weisrc_dish_goods',  'sales')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `sales` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '总销量';");
}
if(!pdo_fieldexists('weisrc_dish_goods',  'credit')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `credit` int(10) NOT NULL DEFAULT '0' COMMENT '奖励积分';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods',  'status')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态';");
}
...
if(!pdo_fieldexists('weisrc_dish_goods_option',  'start')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods_option')." ADD `start` varchar(50) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_intelligent',  'content')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_intelligent')." ADD `content` varchar(1000) NOT NULL DEFAULT '' COMMENT '商品';");
}
...
if(!pdo_fieldexists('weisrc_dish_nave',  'name')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `name` varchar(50) NOT NULL DEFAULT '' COMMENT '导航名称';");
}
if(!pdo_fieldexists('weisrc_dish_nave',  'link')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `link` varchar(200) NOT NULL DEFAULT '' COMMENT '导航链接';");
}
...
if(!pdo_fieldexists('weisrc_dish_order',  'totalnum')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `totalnum` tinyint(4) DEFAULT NULL COMMENT '总数量';");
}
...
if(!pdo_fieldexists('weisrc_dish_order',  'paytype')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `paytype` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1余额，2微信支付，3到付';");
}
...
if(!pdo_fieldexists('weisrc_dish_order',  'username')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `username` varchar(50) NOT NULL DEFAULT '' COMMENT '用户名';");
}
...
if(!pdo_fieldexists('weisrc_dish_order',  'tel')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `tel` varchar(50) NOT NULL DEFAULT '' COMMENT '联系电话';");
}
if(!pdo_fieldexists('weisrc_dish_order',  'meal_time')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `meal_time` varchar(50) NOT NULL DEFAULT '' COMMENT '就餐时间';");
}
...
if(!pdo_fieldexists('weisrc_dish_order',  'remark')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `remark` varchar(1000) NOT NULL DEFAULT '' COMMENT '备注';");
}
...
if(!pdo_fieldexists('weisrc_dish_order_goods',  'optionid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order_goods')." ADD `optionid` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_order_goods',  'optionname')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_order_goods')." ADD `optionname` varchar(200) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_print_order',  'print_usr')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_order')." ADD `print_usr` varchar(50) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_print_setting',  'api_key')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `api_key` varchar(100) DEFAULT '' COMMENT 'api密钥';");
}
...
if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_usr')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_usr` varchar(50) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_top')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_top` varchar(40) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_bottom')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_bottom` varchar(40) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_queue_order',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `from_user` varchar(200) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_queue_order',  'num')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `num` varchar(100) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_queue_order',  'mobile')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `mobile` varchar(30) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_queue_setting',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `title` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_reply',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_reply')." ADD `title` varchar(255) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_reply',  'description')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_reply')." ADD `description` varchar(1000) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_reply',  'picture')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_reply')." ADD `picture` varchar(255) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_reservation',  'storeid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店';");
}
if(!pdo_fieldexists('weisrc_dish_reservation',  'tablezonesid')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `tablezonesid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '餐桌类型id';");
}
if(!pdo_fieldexists('weisrc_dish_reservation',  'time')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `time` varchar(200) NOT NULL DEFAULT '' COMMENT '预定时间';");
}
...
if(!pdo_fieldexists('weisrc_dish_savewine_log',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `from_user` varchar(100) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_savewine_log',  'savenumber')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `savenumber` varchar(100) NOT NULL DEFAULT '' COMMENT '存酒卡号';");
}
if(!pdo_fieldexists('weisrc_dish_savewine_log',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `title` varchar(200) DEFAULT NULL COMMENT '物品名称';");
}
if(!pdo_fieldexists('weisrc_dish_savewine_log',  'username')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `username` varchar(100) DEFAULT NULL COMMENT '用户姓名';");
}
if(!pdo_fieldexists('weisrc_dish_savewine_log',  'tel')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `tel` varchar(30) DEFAULT NULL COMMENT '联系电话';");
}
...
if(!pdo_fieldexists('weisrc_dish_savewine_log',  'status')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态';");
}
...
if(!pdo_fieldexists('weisrc_dish_service_log',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_service_log')." ADD `from_user` varchar(100) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_service_log',  'content')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_service_log')." ADD `content` varchar(1000) DEFAULT NULL COMMENT '内容';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `title` varchar(50) DEFAULT '' COMMENT '网站名称';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `thumb` varchar(200) DEFAULT '' COMMENT '背景图';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'entrance_type')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `entrance_type` tinyint(1) unsigned NOT NULL COMMENT '入口类型1:首页2门店列表3商品列表4我的菜单';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'tploperator')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tploperator` varchar(200) DEFAULT '' COMMENT '模板id';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'link_card_name')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_card_name` varchar(100) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'link_card')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_card` varchar(500) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'link_sign_name')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_sign_name` varchar(100) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'link_sign')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_sign` varchar(500) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'email')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `email` varchar(100) DEFAULT '' COMMENT '平台接收邮件邮箱';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'share_title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `share_title` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'share_desc')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `share_desc` varchar(300) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'share_image')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `share_image` varchar(500) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'follow_url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `follow_url` varchar(500) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_appkey')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_appkey` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_secretkey')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_secretkey` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_verify_code')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_verify_code` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_sign')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_sign` varchar(200) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_setting',  'commission_keywords')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission_keywords` varchar(200) DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_setting',  'tplmission')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tplmission` varchar(200) DEFAULT '' COMMENT '模板id';");
}
...
if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `from_user` varchar(100) DEFAULT '' COMMENT '用户ID';");
}
if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'mobile')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `mobile` varchar(30) DEFAULT '' COMMENT '手机';");
}
if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'checkcode')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `checkcode` varchar(100) DEFAULT '' COMMENT '验证码';");
}
...
if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_username')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_username` varchar(20) DEFAULT '' COMMENT '平台帐号';");
}
if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_pwd')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_pwd` varchar(20) DEFAULT '' COMMENT '平台密码';");
}
if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_mobile')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_mobile` varchar(20) DEFAULT '' COMMENT '商户接收短信手机';");
}
if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_verify_tpl')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_verify_tpl` varchar(120) DEFAULT '' COMMENT '验证短信模板';");
}
if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_business_tpl')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_business_tpl` varchar(120) DEFAULT '' COMMENT '商户短信模板';");
}
if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_user_tpl')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_user_tpl` varchar(120) DEFAULT '' COMMENT '用户短信模板';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `title` varchar(50) NOT NULL DEFAULT '' COMMENT '名称';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'logo')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `logo` varchar(500) NOT NULL DEFAULT '' COMMENT '商家logo';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'info')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `info` varchar(1000) NOT NULL DEFAULT '' COMMENT '简短描述';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'announce')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `announce` varchar(1000) NOT NULL DEFAULT '' COMMENT '公告通知';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'reservation_announce')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `reservation_announce` varchar(1000) NOT NULL DEFAULT '' COMMENT '预定公告';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'tel')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `tel` varchar(20) NOT NULL DEFAULT '' COMMENT '联系电话';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'address')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `address` varchar(200) DEFAULT '' COMMENT '地址';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'qq')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `qq` varchar(20) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'weixin')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `weixin` varchar(20) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'place')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `place` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'password')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `password` varchar(20) NOT NULL DEFAULT '' COMMENT '登录密码';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'hours')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `hours` varchar(200) NOT NULL DEFAULT '' COMMENT '营业时间';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'recharging_password')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `recharging_password` varchar(20) NOT NULL DEFAULT '' COMMENT '充值密码';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'is_rest')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_rest` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否休息中';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'is_hour')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_hour` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_link1')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_link1` varchar(200) NOT NULL DEFAULT '' COMMENT '优惠链接';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_link2')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_link2` varchar(200) NOT NULL DEFAULT '' COMMENT '优惠链接';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_link3')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_link3` varchar(200) NOT NULL DEFAULT '' COMMENT '优惠链接';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'kefu_qrcode')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `kefu_qrcode` varchar(500) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'delivery_within_days')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `delivery_within_days` int(10) NOT NULL DEFAULT '0' COMMENT '允许提前几天点外卖';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'screen_title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `screen_title` varchar(200) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'screen_bg')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `screen_bg` varchar(500) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'screen_bottom')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `screen_bottom` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'business_mobile')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `business_mobile` varchar(30) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_stores',  'jueqi_secret')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `jueqi_secret` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_stores',  'btn_coupon_url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `btn_coupon_url` varchar(500) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_tables',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `title` varchar(200) NOT NULL DEFAULT '' COMMENT '名字(桌台号)';");
}
if(!pdo_fieldexists('weisrc_dish_tables',  'url')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `url` varchar(500) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_tables',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `thumb` varchar(500) NOT NULL DEFAULT '' COMMENT '图片';");
}
...
if(!pdo_fieldexists('weisrc_dish_tables_order',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables_order')." ADD `from_user` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_tablezones',  'title')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `title` varchar(200) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists('weisrc_dish_tpl_log',  'ordersn')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `ordersn` varchar(100) DEFAULT '';");
}
if(!pdo_fieldexists('weisrc_dish_tpl_log',  'from_user')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `from_user` varchar(100) DEFAULT '' COMMENT '接收者openid';");
}
if(!pdo_fieldexists('weisrc_dish_tpl_log',  'content')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `content` varchar(1000) DEFAULT '' COMMENT '内容';");
}
if(!pdo_fieldexists('weisrc_dish_tpl_log',  'result')) {
	pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `result` varchar(200) DEFAULT '' COMMENT '内容结果';");
}
