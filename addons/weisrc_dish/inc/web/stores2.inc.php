...
if ($operation == 'setting') {
    ...
    if (empty($reply)) {
        ...
        $reply['remarkinfo'] = "可输入口味偏好要求(选填)";
        $reply['reservation_announce'] = "20分钟未到店，商家有权取消本次预订，请安排好您的时间";
        $reply['btn_coupon_type'] = "1";
        $reply['btn_coupon_url'] = "";
        $reply['btn_coupon_id'] = "0";
        $reply['btn_coupon_price'] = "15元";
        $reply['btn_coupon_title'] = "商家优惠券";
        $reply['btn_coupon_desc'] = "消费满100元可用";
