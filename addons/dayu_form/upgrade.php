...
if(!pdo_fieldexists("dayu_form", "list")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form")." ADD   `list` tinyint(1) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("dayu_form", "credit")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form")." ADD   `credit` decimal(10;");
}
if(!pdo_fieldexists("dayu_form", "")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form")." ADD 2) NOT NULL DEFAULT '0.00';");
}
...
if(!pdo_fieldexists("dayu_form", "slide")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form")." ADD   `slide` text NOT NULL;");
}
if(!pdo_fieldexists("dayu_form", "guanli")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form")." ADD   `guanli` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form", "weid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form")." ADD   KEY `weid` (`weid`);");
}
if(!pdo_fieldexists("dayu_form_category", "id")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_category")." ADD   `id` int(11) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("dayu_form_category", "weid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_category")." ADD   `weid` int(11) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form_category", "title")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_category")." ADD   `title` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_category", "icon")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_category")." ADD   `icon` varchar(255) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists("dayu_form_category", "color")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_category")." ADD   `color` text NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_category", "list")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_category")." ADD   `list` tinyint(1) NOT NULL;");
}
...
if(!pdo_fieldexists("dayu_form_info", "rethumb")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_info")." ADD   `rethumb` text NOT NULL;");
}
...
if(!pdo_fieldexists("dayu_form_info", "icredit")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_info")." ADD   `icredit` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form_info", "getadd")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_info")." ADD   `getadd` varchar(150) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_info", "getip")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_info")." ADD   `getip` varchar(20) NOT NULL;");
}
...
if(!pdo_fieldexists("dayu_form_linkage", "parentid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_linkage")." ADD   `parentid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '上级分类ID;");
}
if(!pdo_fieldexists("dayu_form_linkage", "")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_linkage")." ADD 0为第一级';");
}
...
if(!pdo_fieldexists("dayu_form_plugin_radio", "id")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `id` int(11) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("dayu_form_plugin_radio", "weid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `weid` smallint(6) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_plugin_radio", "cid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `cid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_plugin_radio", "title")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `title` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_plugin_radio", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `thumb` varchar(250) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists("dayu_form_plugin_radio", "album")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `album` text NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_plugin_radio", "status")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `status` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form_plugin_radio", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio")." ADD   `createtime` int(10) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form_plugin_radio_category", "id")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio_category")." ADD   `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("dayu_form_plugin_radio_category", "weid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio_category")." ADD   `weid` smallint(6) unsigned NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_plugin_radio_category", "title")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio_category")." ADD   `title` varchar(100) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists("dayu_form_plugin_radio_category", "status")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_plugin_radio_category")." ADD   `status` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("dayu_form_record", "id")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `id` int(11) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("dayu_form_record", "rerid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `rerid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_record", "openid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `openid` varchar(50) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_record", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `thumb` text NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_record", "info")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `info` varchar(500) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_record", "r")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `r` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_record", "status")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `status` tinyint(1) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_record", "createtime")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_record")." ADD   `createtime` int(10) NOT NULL DEFAULT '0';");
}
...
if(!pdo_fieldexists("dayu_form_skins", "id")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_skins")." ADD   `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("dayu_form_skins", "title")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_skins")." ADD   `title` varchar(50) NOT NULL DEFAULT '';");
}
if(!pdo_fieldexists("dayu_form_skins", "name")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_skins")." ADD   `name` varchar(50) NOT NULL DEFAULT '';");
}
...
if(!pdo_fieldexists("dayu_form_skins", "description")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_skins")." ADD   `description` varchar(100) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_skins", "ids")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_skins")." ADD   `ids` text NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_skins", "mode")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_skins")." ADD   `mode` tinyint(1) NOT NULL DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form_skins", "status")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_skins")." ADD   `status` tinyint(1) NOT NULL DEFAULT '1';");
}
if(!pdo_fieldexists("dayu_form_slide", "id")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `id` int(11) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists("dayu_form_slide", "weid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `weid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form_slide", "cid")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `cid` int(11) NOT NULL;");
}
if(!pdo_fieldexists("dayu_form_slide", "title")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `title` varchar(50) DEFAULT '';");
}
if(!pdo_fieldexists("dayu_form_slide", "link")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `link` varchar(255) DEFAULT '';");
}
if(!pdo_fieldexists("dayu_form_slide", "thumb")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `thumb` varchar(255) DEFAULT '';");
}
if(!pdo_fieldexists("dayu_form_slide", "displayorder")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `displayorder` smallint(3) DEFAULT '0';");
}
if(!pdo_fieldexists("dayu_form_slide", "enabled")) {
 pdo_query("ALTER TABLE ".tablename("dayu_form_slide")." ADD   `enabled` tinyint(1) NOT NULL DEFAULT '0';");
}
