...
$pagesize=10;
$sql="select a.*,b.type_name  from " . tablename("zhvip_goods") ."a"  . " left join " . tablename("zhvip_type2") . " b on b.id=a.type_id WHERE  a.name LIKE :name  and a.uniacid=:uniacid and a.store_id=".$storeid;
