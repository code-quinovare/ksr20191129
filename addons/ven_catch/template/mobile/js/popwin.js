...
showWin: function(width, height, title, src) {
        ...
        var inntHtml = '';
        inntHtml += '<div id="mask" style="display:none;z-index:99999999;width:100%; height:100%; position:fixed; top:0; left:0;background:#cccccc; filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity:0.5;"></div>'
        inntHtml += '<div id="maskTop" style="left:0px;z-index:99999999;width:100%;height:100%;background:rgba(52, 52, 52, 0.3);color: #333; position: fixed;margin-top: -' + marginTop + 'px; filter: progid:DXImageTransform.Microsoft.Shadow(color=#909090,direction=120,strength=4);">'
        ...
        //inntHtml += '</div>'
        //width="' + width + '" height="' + iframeHeight + '"
        inntHtml += '<iframe style="width:100%;height:100%;" id="myiframe"  frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe>';
