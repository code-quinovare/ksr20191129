...
<?php  if($is_offic) { ?>
<div class="fui-content offic-block">
            ...
            <?php  if($hasSales && empty($seckillinfo)) { ?>
                ...
                <div class="sale-line">
                    ...
                    <span>
                            ...
                            <?php  if($enoughfree) { ?>全场满 <span class="text-danger">&yen;<?php  echo $enoughfree;?></span> 包邮; <?php  } ?>
                            <?php  } ?>
                        </span>
                </div>
                <?php  } ?>
...
<div class="fui-cell-group fui-shop-group">
    <a class='fui-list' href="<?php  echo $shopdetail['btnurl2'];?>">
        ...
        <div class='fui-list-inner'>
            <div class='title' style="<?php  if(p('offic')) { ?>display: none;<?php  } ?>"><?php  echo $shopdetail['shopname'];?></div>
