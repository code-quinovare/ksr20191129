	...
	<form action="<?php  echo url('article/news/post');?>" method="post" class="we7-form" role="form" id="form1">
		<input type="hidden" name="id" value="<?php  echo $new['id'];?>"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="help-block"><input type="checkbox" id="autolitpic" name="autolitpic" value="1"<?php  if(empty($item['thumb'])) { ?> checked="true"<?php  } ?>><label class="checkbox" for="autolitpic">提取内容的第一个图片为缩略图</label></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="radio" id="is_display-1" name="is_display" value="1" <?php  if($new['is_display'] == 1) { ?> checked<?php  } ?>> 
						<label class="radio-inline" for="is_display-1">显示</label>
						<input type="radio" name="is_display" id="is_display-0" value="0" <?php  if($new['is_display'] == 0) { ?> checked<?php  } ?>>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="radio" name="is_show_home" id="is_show_home-1" value="1" <?php  if($new['is_show_home'] == 1) { ?> checked<?php  } ?>> 
						<label class="radio-inline" for="is_show_home-1">是</label>
						<input type="radio" name="is_show_home" id="is_show_home-0" value="0" <?php  if($new['is_show_home'] == 0) { ?> checked<?php  } ?>>
