...
<table class="table table-responsive">
    ...
    <tr>
        ...
        <td> 
            <?php if(cv('diyform.temp.edit|diyform.temp.view')) { ?><a class='btn btn-sm btn-default' href="<?php  echo webUrl('diyform/temp/edit', array( 'id' => $item['id']))?>"><i class='fa fa-edit'></i> <?php if(cv('diyform.temp.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a><?php  } ?>
