...
<div class="page-heading"> <h2>拼团概述</h2> </div>
<div class="form-group-title">拼团</div>
<div class="row">
    <div class="col-md-6 col-sm-6">
        <div class="ibox float-e-margins" style="border: 1px solid #e7eaec">
            <div class="ibox-title">
                <span class="label label-success pull-left">已成团</span>
                <h5></h5>
            </div>
            <div class="ibox-content">

                <div class="row">
                    <div class="col-md-12 text-center groups_pointer" onclick="javascript:window.location.href='<?php  echo webUrl('groups/team', array('type' => success))?>'">
                        数量
    ...
    <div class="col-md-6 col-sm-6">
        <div class="ibox float-e-margins" style="border: 1px solid #e7eaec">
            <div class="ibox-title">
                <span class="label label-primary pull-left">拼团中</span>
                <h5></h5>
            </div>
            <div class="ibox-content">
