...
<head>
    ...
    <title><?php  if(!empty($copyright) && !empty($copyright['title'])) { ?><?php  echo $copyright['title'];?><?php  } ?>北京快舒尔医疗技术有限公司</title>
	...
	<style>
		#newUploaderImg.image .img-container, .uploader-modal.image .img-container{width:800px;}
	</style>
