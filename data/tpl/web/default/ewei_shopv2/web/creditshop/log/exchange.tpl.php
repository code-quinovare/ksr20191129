<?php defined('IN_IA') or exit('Access Denied');?> 
    ...
    <form class="form-horizontal form-validate" action="<?php  echo webUrl('creditshop/log/doexchange')?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <?php  if($goods['isverify']) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                                <div class='form-control-static'>
                                    <?php  echo $store['storename'];?> <br/> <?php  echo $store['address'];?>
                                </div>
                            </div>
                        </div>
                        <?php  if($log['verifynum'] > 0) { ?>
                            <div class="form-group">
                                <label class="col-xs-10 col-sm-3 col-md-3 control-label">兑换次数</label>
                                <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                                    <div class='form-control-static'>
                                        <input type="text" name="verifynum" class="form-control valid" value="<?php  echo $log['verifynum'];?>">
                                    </div>
                                </div>
                            </div>
                        <?php  } ?>
                    ...
                    <?php  } else { ?>
                        <?php  if($goods['goodstype']==3) { ?>
                            <div class="form-group">
                                <label class="col-xs-10 col-sm-3 col-md-3 control-label">红包金额</label>
                                <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                                    <div class='form-control-static'>
                                        <input type="text" name="" class="form-control valid" disabled value="<?php  echo $goods['grant2'];?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
