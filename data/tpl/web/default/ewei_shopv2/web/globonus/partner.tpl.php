...
<div class="page-heading"> <h2>股东管理 <small>总数: <span class='text-danger'><?php  echo $total;?></span></small></h2> </div>
...
<?php  if(count($list)>0) { ?>
        ...
        <table class="table table-hover table-responsive">
           ...
           <tr rel="pop" data-title="ID: <?php  echo $row['id'];?> " data-content="推荐人 <br/> <?php  if(empty($row['agentid'])) { ?>
                ...
                <td><?php  if(!empty($row['partnertime'])) { ?>
                ...
                <td>
                    ...
                    <span class='label <?php  if($row['partnerstatus']==1) { ?>label-success<?php  } else { ?>label-default<?php  } ?>'
                ...
                <td  style="overflow:visible;">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left">
                            ...
                            <?php if(cv('globonus.partner.delete')) { ?><li><a data-toggle='ajaxRemove' href="<?php  echo webUrl('globonus/partner/delete',array('id' => $row['id']));?>" title="删除" data-confirm="确定要删除该股东吗？"><i class='fa fa-remove'></i> 删除股东</a></li><?php  } ?>
