...
<div class="page-heading" style="margin-bottom:0">
    <span class="pull-right">
        <a class="btn btn-default btn-sm" href="<?php  echo webUrl('exchange/score')?>">返回列表</a>
        </span>
    <h2><?php  if($id>0) { ?>编辑商品兑换任务<?php  } else { ?>添加商品兑换任务<?php  } ?></h2>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9  col-xs-12">
        <label for="binding" class="radio-inline"><input type="checkbox" name="binding" id="binding" <?php  if($setting['binding'] == 1) { ?>checked<?php  } ?>> 开启扫码绑定</label>
    </div>
</div>
<div class="form-group">
...
<div class="tab-pane fade" id="message">
    <form action="<?php  if($setting['code_type'] != 3) { ?><?php  echo webUrl('exchange/goods/setting',array('id'=>$id),1);?><?php  } else { ?><?php  echo webUrl('exchange/goods/addreply',array('id'=>$id),1);?><?php  } ?>" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <input type="radio" name="reply" class="type" value="0" id="on" onclick="$('#yulan').show();$('#wenzi').hide();" <?php  if($setting['reply_type'] == 0) { ?>checked<?php  } ?>><label for="on"> 图文消息</label>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="reply" class="type" value="1" id="off" onclick="$('#yulan').hide();$('#wenzi').show();" <?php  if($setting['reply_type'] == 1) { ?>checked<?php  } ?>><label for="off"> 文字消息</label>
            </div>
        </div>
        <?php  } ?>
