                        ...
                        <?php  if(!$isonlyverifygoods) { ?>
                            ...
                            <?php  } else { ?>
                                ...
                                <tr>
                                    ...
                                    <td style='word-break: break-all;white-space: normal'><?php  echo html_entity_decode($user['address'])?>,  <?php  echo $user['realname'];?>, <?php  echo $user['mobile'];?></td>
                                </tr>
                            <?php  } ?>
                        <?php  } ?>
                    ...
                    <td class='full'>
                        <?php  if(!empty($goods['optionname'])) { ?>
                            <span style="white-space:normal;">规格：
                                <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="right" data-content="<?php  echo $goods['optionname'];?>" data-original-title="" title="" style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:90px;padding:0 3px;">
