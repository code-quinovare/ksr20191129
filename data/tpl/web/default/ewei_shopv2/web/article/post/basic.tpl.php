...
<div class="form-group">
	<label class="col-sm-2 control-label">阅读全文</label>
...
<div class="form-group">
	<label class="col-sm-2 control-label">虚拟阅读数</label>
...
<div class="form-group">
	<label class="col-sm-2 control-label">举报设置</label>
...
<div class="form-group">
	<label class="col-sm-2 control-label">阅读区域</label>
	<div class="col-sm-9 col-xs-12">
...
<div class="form-group">
	<label class="col-sm-2 control-label">回复关键词</label>
	<div class="col-sm-9 col-xs-12">
