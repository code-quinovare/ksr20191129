...
<div class='page-heading'>
 ...
 <form id="setform"  action="" method="post" class="form-horizontal form-validate">
        <div class="form-group">
            <label class="col-sm-2 control-label">奖励发放通知</label>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">素材目录设置</label>
            <div class="col-sm-9 col-xs-12">
            	<?php if(cv('article.set.edit')) { ?>
...
<div class="form-group" >
                <label class="col-sm-2 control-label">直接链接<br><small>(点击链接复制)</small></label>
                <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">默认数量</label>
            <div class="col-sm-9 col-xs-12">
            	<?php if(cv('article.set.edit')) { ?>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">列表页关键字</label>
            <div class="col-sm-9 col-xs-12">
            	<?php if(cv('article.set.edit')) { ?>
