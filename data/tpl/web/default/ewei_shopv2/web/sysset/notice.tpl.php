...
<style>
    ...
    #openids3_selector .input-group {width: 100%;}
...
<form action="" method="post" class="form-horizontal  form-validate" enctype="multipart/form-data" >
    ...
    <table class="table table-responsive">
        ...
        <?php  if(p('newstore')) { ?>
            <tr>
                <td>商品预约通知</td>
                <td>
                    <select class="select2 is_advanced" name="data[o2o_snorder_template]">
                        <option value=''>[默认]商品预约通知</option>
                        <?php  if(is_array($template_group['o2o_snorder'])) { foreach($template_group['o2o_snorder'] as $template_val) { ?>
                        <option value="<?php  echo $template_val['id'];?>" <?php  if($data['o2o_snorder_template'] == $template_val['id'] ) { ?>selected<?php  } ?>><?php  echo $template_val['title'];?></option>
                        <?php  } } ?>
                    </select>
                </td>
                <td style="text-align: right;" class="is_advanced">
                    <label class="notice-default">
                        <input type="hidden" name="data[o2o_snorder_close_advanced]" value="<?php  echo intval($data['o2o_snorder_close_advanced'])?>" />
                        <input class="js-switch small checkone" data-type="tpl-advanced"  data-tag="o2o_snorder"  type="checkbox" value="<?php  echo intval($data['o2o_snorder_close_advanced'])?>" <?php  if(empty($data['o2o_snorder_close_advanced'])) { ?>checked<?php  } ?>/>
                    </label>
                    <label style="display: none;">
                        <img src="../addons/ewei_shopv2/static/images/loading.gif" width="20" alt=""/>
                    </label>
                ...
                <td class="is_sms">
                    <select class="select2" name="data[o2o_snorder_sms]">
                        <option value=''>从短信消息库中选择</option>
                        <?php  if(is_array($template_sms)) { foreach($template_sms as $template_val) { ?>
                        <option value="<?php  echo $template_val['id'];?>" <?php  if($data['o2o_snorder_sms'] == $template_val['id'] ) { ?>selected<?php  } ?>><?php  echo $template_val['name'];?></option>
                        <?php  } } ?>
                    </select>
                </td>
                <td style="text-align: right;" class="is_sms">
                    <input type="hidden" name="data[o2o_snorder_close_sms]" value="<?php  echo intval($data['o2o_snorder_close_sms'])?>" />
                    <input class="js-switch small checkone" data-type="sms" type="checkbox" value="<?php  echo intval($data['o2o_snorder_close_sms'])?>" <?php  if(empty($data['o2o_snorder_close_sms'])) { ?>checked<?php  } ?>/>
                </td>
            </tr>
        <?php  } ?>
        </tbody>
    ...
    <table class="table table-responsive">
        ...
        <tr>
            <td>商品预约成功通知</td>
            <td>
                <select class="select2 is_advanced" name="data[o2o_bnorder_template]">
                    <option value=''>[默认]商品预约成功通知</option>
                    <?php  if(is_array($template_group['o2o_bnorder'])) { foreach($template_group['o2o_bnorder'] as $template_val) { ?>
                    <option value="<?php  echo $template_val['id'];?>" <?php  if($data['o2o_bnorder_template'] == $template_val['id'] ) { ?>selected<?php  } ?>><?php  echo $template_val['title'];?></option>
                    <?php  } } ?>
                </select>
            </td>
            <td style="text-align: right;" class="is_advanced">
                <label class="notice-default">
                    <input type="hidden" name="data[o2o_bnorder_close_advanced]" value="<?php  echo intval($data['o2o_bnorder_close_advanced'])?>" />
                    <input class="js-switch small checkone" data-type="tpl-advanced"  data-tag="o2o_bnorder"  type="checkbox" value="<?php  echo intval($data['o2o_bnorder_close_advanced'])?>" <?php  if(empty($data['o2o_bnorder_close_advanced'])) { ?>checked<?php  } ?>/>
                </label>
                <label style="display: none;">
                    <img src="../addons/ewei_shopv2/static/images/loading.gif" width="20" alt=""/>
                </label>
            ...
            <td class="is_sms">
                <select class="select2" name="data[o2o_bnorder_sms]">
                    <option value=''>从短信消息库中选择</option>
                    <?php  if(is_array($template_sms)) { foreach($template_sms as $template_val) { ?>
                    <option value="<?php  echo $template_val['id'];?>" <?php  if($data['o2o_bnorder_sms'] == $template_val['id'] ) { ?>selected<?php  } ?>><?php  echo $template_val['name'];?></option>
                    <?php  } } ?>
                </select>
            </td>
            <td style="text-align: right;" class="is_sms">
                <input type="hidden" name="data[o2o_bnorder_close_sms]" value="<?php  echo intval($data['o2o_bnorder_close_sms'])?>" />
                <input class="js-switch small checkone" data-type="sms" type="checkbox" value="<?php  echo intval($data['o2o_bnorder_close_sms'])?>" <?php  if(empty($data['o2o_bnorder_close_sms'])) { ?>checked<?php  } ?>/>
            </td>
        </tr>
        <?php  } ?>
        </tbody>
