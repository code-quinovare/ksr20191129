    ...
    <div class="col-sm-12">
        ...
        <div id="alipay" style="<?php  if(empty($data['paytype'])) { ?>display: none;<?php  } ?>">
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-9">
                    <?php if(cv('sysset.payset.edit')) { ?>
                    <textarea name="data[app_alipay_public_key]" data-rule-required='true' rows="4" class="form-control"><?php  if(!empty($sec['alipay_sec']['public_key'])) { ?><?php  echo $sec['alipay_sec']['public_key'];?><?php  } ?></textarea>
