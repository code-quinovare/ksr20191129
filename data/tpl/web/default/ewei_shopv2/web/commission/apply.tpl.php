...
<div class="page-heading"> <h2><?php  echo $applytitle;?>提现申请 总数：<?php  echo $total;?> <?php  if($status == 3) { ?>发送总额 : <?php  echo $realmoney_total;?><?php  } ?></h2> </div>
...
<table class="table table-hover">
    ...
    <tr>
        ...
        <th style='width:100px;'>申请佣金<br><?php  if($status==3) { ?>实际到账<?php  } else { ?>实际佣金<?php  } ?><br>提现手续费
        </th>
