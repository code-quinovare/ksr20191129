    ...
    <div id="advanced">
        ...
        <table class="table table-responsive">
            ...
            <tr>
                ...
                <td>
                    <label class="radio-inline"><input type="radio" value="0" name="data[commission_agent_new_advanced_notice]" <?php  if(empty($data['tm']['commission_agent_new_advanced_notice'])) { ?>checked=""<?php  } ?>> <?php echo empty($data['texts']['c1'])?'一级':$data['texts']['c1']?>[默认]</label><br>
                    <label class="radio-inline"><input type="radio" value="1" name="data[commission_agent_new_advanced_notice]" <?php  if(strexists($data['tm']['commission_agent_new_advanced_notice'],'1')) { ?>checked=""<?php  } ?>> <?php echo empty($data['texts']['c1'])?'一级':$data['texts']['c1']?>+<?php echo empty($data['texts']['c2'])?'二级':$data['texts']['c2']?></label><br>
        ...
        <table class="table table-responsive">
            ...
            <tr>
                ...
                <td>
                    <label class="radio-inline"><input type="radio" value="0" name="data[commission_order_pay_advanced_notice]" <?php  if(empty($data['tm']['commission_order_pay_advanced_notice'])) { ?>checked=""<?php  } ?>> <?php echo empty($data['texts']['c1'])?'一级':$data['texts']['c1']?>[默认]</label><br>
                    <label class="radio-inline"><input type="radio" value="1" name="data[commission_order_pay_advanced_notice]" <?php  if(strexists($data['tm']['commission_order_pay_advanced_notice'],'1')) { ?>checked=""<?php  } ?>> <?php echo empty($data['texts']['c1'])?'一级':$data['texts']['c1']?>+<?php echo empty($data['texts']['c2'])?'二级':$data['texts']['c2']?></label><br>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label class="radio-inline"><input type="radio" value="1" name="data[commission_order_finish_advanced_notice]" <?php  if(strexists($data['tm']['commission_order_finish_advanced_notice'],'1')) { ?>checked=""<?php  } ?>><?php echo empty($data['texts']['c1'])?'一级':$data['texts']['c1']?>+<?php echo empty($data['texts']['c2'])?'二级':$data['texts']['c2']?></label><br>
