        ...
        <div class="col-sm-9 col-xs-12">
            <div class="input-group" style="width: 450px;">
                <span class="form-control" style="width: 120px;">
                    <label class="checkbox-inline" style="padding-top: 0;"><input type="checkbox" value="1" <?php  if(!empty($set['signold'])) { ?>checked<?php  } ?> <?php if(cv('sign.rule.edit')) { ?>name="signold"<?php  } else { ?>disabled<?php  } ?>> 开启补签</label>
                </span>
                ...
                <span class="input-group-addon" style="border-left: 0;">
                    <label class="radio-inline" style="padding-top: 0;"><input type="radio" value="0" <?php  if(empty($set['signold_type'])) { ?>checked<?php  } ?> <?php if(cv('sign.rule.edit')) { ?>name="signold_type"<?php  } else { ?>disabled<?php  } ?>> 余额</label>
                    <label class="radio-inline" style="padding-top: 0;"><input type="radio" value="1" <?php  if(!empty($set['signold_type'])) { ?>checked<?php  } ?> <?php if(cv('sign.rule.edit')) { ?>name="signold_type"<?php  } else { ?>disabled<?php  } ?>> 积分</label>
                </span>
            </div>
