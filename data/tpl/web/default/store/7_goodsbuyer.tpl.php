			...
			<a href="<?php  echo $this->createWebUrl('goodsbuyer', array('operate' => 'goods_info', 'direct' => 1, 'goods' => $goods['id']))?>">
				...
				<div class="name text-over">
					<?php  if($goods['type'] == STORE_TYPE_PACKAGE) { ?>
						<?php  echo $module_groups[$goods['module_group']]['name'];?>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr class="submenu">
							<td class="td_one" colspan="3">
								...
								<span class="icon">
									<i class="wi wi-wechat"></i> <?php echo empty($module_groups[$goods['module_group']]['modules'])? 0 : count($module_groups[$goods['module_group']]['modules'])?>
...
<div><span class="wi wi-userjurisdiction">用户权限组</span></div>
<div class="store">
	<div class="jurisdiction-list">
		<?php  if(is_array($store_goods)) { foreach($store_goods as $goods) { ?>
		<div class="panel we7-panel">
