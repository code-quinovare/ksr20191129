	...
	<body style="background-color:#28b0e4;">
		<div class="container">
			...
			<div class="footer" style="margin:15px auto;">
				...
				<div class="text-center">
					Powered by <a href="http://www.we7.cc"><b>微擎</b></a> v1.81 &copy; 2018 <a href="http://www.we7.cc">www.we7.cc</a>
				</div>
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="//wpa.qq.com/msgrd?v=3&uin=3086811716&site=qq&menu=yes"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="微擎模块交流" title="微擎模块交流"></a>
						</label>
